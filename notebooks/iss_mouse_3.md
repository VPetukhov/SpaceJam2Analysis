...
@time df_spatial, gene_names = Baysor.load_df("$DATA_PATH/ISS_3_spot_table.csv"; 
...
```julia
cur_df = @where(df_spatial, :x .> 12000, :x .< 15000, :y .> 10000, :y .< 13000) |> deepcopy;
...
CSV.write("../output/iss_mouse_3/cm.tsv", Baysor.convert_segmentation_df_to_cm(segmentation_df), delim="\t")
CSV.write("../output/iss_mouse_3/cell_stat.csv", cell_stat_df[:, out_stat_names]);
CSV.write("../output/iss_mouse_3/segmentation.csv", segmentation_df[:, names(segmentation_df) .!= :mol_id]);
```
